...
import {
  ...
  User, Users, Sparkles, Trash2, RefreshCw,
} from "lucide-react";
    ...
    <div className="p-8">
      ...
      <div className="flex items-center gap-4 mb-6 text-xs font-mono">
        ...
        <button
          ...
          className="flex items-center gap-1 ml-auto px-2.5 py-1.5 rounded-lg text-[11px] font-medium bg-muted text-muted-foreground hover:bg-accent hover:text-accent-foreground transition-colors disabled:opacity-50"
        >
        ...
        <div className="bg-card border border-border rounded-[14px] p-5">
          ...
          <div className="space-y-1">
            {clientTasks.map((task) => (
              ...
              >
                ...
                >
                  {task.text}
                  {task.autoGenerated && (
                    <span className="ml-1.5 text-[9px] font-mono text-muted-foreground/40">(AI)</span>
                  )}
                </span>
                <button
            ...
            {clientTasks.length === 0 && (
              <p className="text-xs text-muted-foreground text-center py-6">No client tasks.</p>
            )}
          </div>
        </div>
        ...
        <div className="bg-card border border-border rounded-[14px] p-5">
          ...
          <div className="space-y-1">
            ...
            {internalTasks.length === 0 && (
              <p className="text-xs text-muted-foreground text-center py-6">No internal tasks.</p>
            )}
          </div>
        </div>
      </div>
