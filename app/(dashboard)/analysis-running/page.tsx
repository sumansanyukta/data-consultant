...
const ANALYSIS_STAGES = [
  {
    id: "brief",
    label: "Parsing client brief",
    detail: "Extracting intent, entities, and key business questions",
  },
  {
    id: "data",
    label: "Checking data quality",
    detail: "Profiling columns, detecting nulls, type mismatches, outliers",
  },
  {
    id: "context",
    label: "Extracting business context",
    detail: "Identifying sector patterns, comparable benchmarks",
  },
  {
    id: "hypotheses",
    label: "Generating hypotheses",
    detail: "Structuring candidate explanations for the problem",
  },
  {
    id: "recommendations",
    label: "Forming recommendations",
    detail: "Prioritising analyses by confidence and feasibility",
  },
];
    ...
    <div className="flex-1 flex items-center justify-center p-8">
      <div className="w-full max-w-xl">
        <div className="text-center mb-8">
          <div
            className={`w-14 h-14 rounded-2xl mx-auto mb-4 flex items-center justify-center transition-all duration-500 ${
              done ? "bg-emerald-100" : "bg-accent"
            }`}
          >
            {done ? (
          ...
          <p className="text-sm text-muted-foreground">
            {done
              ? "Your structured starting point is ready for review."
              : "BVG Ridership Decline Q1–Q2 2024"}
          </p>
        </div>
